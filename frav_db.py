...
count = 1
count = insert_data(FOLDER + "FIR/DATA/logitech_fluorescente_data.txt", "fir_data", con, cur, count)
count = insert_data(FOLDER + "FIR/DATA/logitech_halogeno_data.txt", "fir_data", con, cur, count)
count = insert_data(FOLDER + "FIR/DATA/logitech_led_data.txt", "fir_data", con, cur, count)
count = insert_data(FOLDER + "FIR/DATA/logitech_nir_data.txt", "fir_data", con, cur, count)
count = insert_data(FOLDER + "FIR/DATA/microsoft_fluorescente_data.txt", "fir_data", con, cur, count)
count = insert_data(FOLDER + "FIR/DATA/microsoft_halogeno_data.txt", "fir_data", con, cur, count)
count = insert_data(FOLDER + "FIR/DATA/microsoft_led_data.txt", "fir_data", con, cur, count)
print("----------------------------------------------------------")
